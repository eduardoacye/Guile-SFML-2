...
;;;
;;; file: sfml2/graphics/transformable-unsafe.scm
;;; 
;;; Module that exports the <sf-transformable> record and the associated
;;; procedures.
;;;
...
;;; record for the sfTransformable opaque structure
